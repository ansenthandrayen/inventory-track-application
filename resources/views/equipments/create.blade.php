...
@section('content')
    ...
    <div class="max-w-2xl mx-auto">
        <h1 class="text-2xl font-bold text-gray-800 mb-6">Ajouter un équipement</h1>
            ...
            <form action="{{ route('equipments.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <select name="status" class="w-full border rounded px-3 py-2 @error('status') border-red-500 @enderror">
                        ...
                        <option value="en_utilisation"  {{ old('status') == 'en_utilisation'  ? 'selected' : '' }}>En utilisation</option>
